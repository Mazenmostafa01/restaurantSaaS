...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
        ...
        <div class="relative h-48 w-full bg-gray-100">
            <div class="item-slider-{{ $item->id }} swiper-container w-full h-full">
                <div class="swiper-wrapper">
                    ...
                    @else
                        <div class="swiper-slide">
                            <div class="w-full h-full flex items-center justify-center bg-gray-100">
                                <img src="{{ asset('storage/images/burger-1396639_1280.png') }}" {{-- add you alternative if there is no photo --}}
                                     alt="Default Image"
                                     class="w-full h-full object-cover">
                            </div>
                        </div>
        ...
        <div class="p-4 flex flex-col flex-grow">
            ...
            <p class="text-gray-600 text-sm mb-3 line-clamp-2 flex-grow">{{ $item->description }}</p>
